...
import { DAuthors, DBooks, DMan, DNewBooks } from "../data/books.js";
...
BockRouter.get("/manufacturers",(req,res)=>{
    setTimeout(()=>res.send(DMan),2000)
})
BockRouter.get("/authors",(req,res)=>{
    setTimeout(()=>res.send(DAuthors),2000)
})
